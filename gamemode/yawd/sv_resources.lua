...
resource.AddFile("entities/wep_build.png")
resource.AddFile("entities/yawd_fists.png")
resource.AddFile("entities/yawd_fists_extreme.png")
resource.AddFile("entities/yawd_lmg.png")
resource.AddFile("entities/yawd_pistol.png")
resource.AddFile("entities/yawd_rifle.png")
resource.AddFile("entities/yawd_shotgun.png")
resource.AddFile("entities/yawd_sniper.png")
