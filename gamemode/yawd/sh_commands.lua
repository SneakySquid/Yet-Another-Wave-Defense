...
-- Gives currency
concommand.Add( "yawd_give_currency", function(ply, cmd, args)
...
-- Sets the wavenumber
concommand.Add( "yawd_set_wave", function(ply, cmd, args)
	local num = tonumber(args) or 0
	GAMEMODE:SetWaveNumber( num )
end, nil, "Sets the wave number", FCVAR_CHEAT )

-- Deletes all NPCs from current wave
concommand.Add( "yawd_delete_npcs", function(ply, cmd, args)
